...
Route::get('odo-backdate-bulk-approval/{yearId}/{employeeId}', [OdometerBackdateController::class, 'odoBackdateBulkApproval']);
Route::get('odo-backdate-bulk-rejection/{yearId}/{employeeId}', [OdometerBackdateController::class, 'odoBackdateBulkRejection']);
