            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body p-0 pb-2">
                            <div style="height: 400px" id="multi_chart" data-colors='["--vz-primary", "--vz-info", "--vz-success"]' dir="ltr"
                                class="apex-charts"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered">
                        ...
                        <tfoot class="table-light" id="modal-table-footer">
                        </tfoot>
                    </table>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered">
                        ...
                        <tfoot class="table-light" id="department-table-footer">
                        </tfoot>
                    </table>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-sm table-hover">
                        ...
                        <tbody id="claim-type-table-body">
                        </tbody>
                        <tfoot id="claim-type-table-footer">
                        </tfoot>
                    </table>
                </div>
            </div>
