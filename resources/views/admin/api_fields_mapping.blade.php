                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1"><i class="ri-list-unordered"></i> Field Mapping
                                {{ $claim_id }}</h4>
                            ...
                            <form id="mapping-form">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th scope="col" rowspan="2" class="text-center" style="width: 150px; align-content: center;">Temp Column</th>
                                                <th scope="col" rowspan="2" class="text-center" style="width: 120px; align-content: center;">Input Type</th>
                                                <th scope="col" colspan="3" class="text-center">Select Lookup (if Input Type is 'Select')</th>
                                                <th scope="col" colspan="2" class="text-center">Target Punch Table</th>
                                                <th scope="col" rowspan="2" class="text-center" style="width: 200px; align-content: center;">Condition</th>
                                            </tr>
                                            <tr>
                                        ...
                                        <tbody id="mapping-rows">
                                            @foreach ($columns as $index => $column)
                                                <tr data-temp-column="{{ $column }}">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control select-table" name="select_table[]" disabled>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control search-column" name="search_column[]" disabled>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control return-column" name="return_column[]" disabled>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control punch-table" name="punch_table[]">
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control punch-column" name="punch_column[]">
                                                    </td>
                                                    <td>
