                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-12">
                                 <div class="mb-3 pb-2">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea" placeholder="Enter your description" rows="3">N/A</textarea>
                                 </div>
                              </div>
                              <div class="col-lg-12">
